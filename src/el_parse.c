...
internal Ast_Expression *make_compound_literal_expression(Parser *parser, Ast_Expression *type_annotation, Ast_Expression *exprs, Range1DI32 loc) {
...
#if 0
internal Ast_Expression *parse_type_annotation(Parser *parser) {
